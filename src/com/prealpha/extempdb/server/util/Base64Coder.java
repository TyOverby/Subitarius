...
public final class Base64Coder {
	 ...
	 */
	/*
	 * Rewritten to avoid use of s.getBytes() (not in GWT)
	 * 
	 * Note that this algorithm silently ignores the most significant byte in
	 * each char.
	 */
	 ...
	 */
	/*
	 * Rewritten to avoid use of new String(byte[]) (not in GWT)
	 * 
	 * Note that this algorithm treats each received byte as a distinct char.
	 */
