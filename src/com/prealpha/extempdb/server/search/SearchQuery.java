...
final class SearchQuery {
	...
	public ArticleParser getArticleParser(Injector injector) {
		Class<? extends ArticleParser> parserClass = source.getParserClass();
		return injector.getInstance(parserClass);
	}
	...
	/*
	 * TODO: maybe re-generate these later
	 */
	@Override
	public int hashCode() {
		final int prime = 31;
	...
	public String toString() {
		return String.format("SearchQuery[source=\"%s\", tag=\"%s\"]", source.getDisplayName(), tag.getName());
	}
}
