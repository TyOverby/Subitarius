...
final class WsjArticleParser extends AbstractArticleParser {
	private static enum ArticleType {
		COMPLETE("div.articlePage > p"), ABRIDGED("div.article > p");
		...
		private String getBodySelector() {
			return bodySelector;
		}
	}
	...
	private static ProtoArticle getFromHtml(Document document)
		...
		List<Element> elements = document.select(type.getBodySelector());
